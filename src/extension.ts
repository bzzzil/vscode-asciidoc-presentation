...
const completionItemsJson = [
  ...
  },
  {
    ...
    detail:
      "Display the page number of the current slide? true/false or format string",
  ...
  },
  {
    ...
    detail:
      "Add the current slide number to the URL hash so that reloading the page returns you to the same slide",
    values: ["true", "false"],
  },
  {
  ...
  },
  {
    ...
    detail:
      "Auto-advance slides at the given interval in milliseconds (0 = disabled)",
  },
  {
  ...
  },
  {
    ...
    detail:
      "Amount of pixels to move the parallax background per horizontal slide step",
  },
  {
    label: ":revealjs_parallaxBackgroundVertical:",
    description: "Parallax vertical movement (px)",
    detail:
      "Amount of pixels to move the parallax background per vertical slide step",
  },
  {
    label: ":highlightjs-theme:",
    description: "Syntax highlighting theme",
    detail:
      "Syntax highlighting theme for code blocks (see https://highlightjs.org/demo)",
    values: [
      "monokai",
      "github",
      "github-dark",
...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.preview", () =>
      showPreview(containerManager),
    ),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand(
      "asciiDocPresentation.exportHtml",
      (...args: any[]) => exportHtml(containerManager, args),
    ),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand(
      "asciiDocPresentation.exportInlinedHtml",
      () => exportInlinedHtml(containerManager),
    ),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.openInBrowser", () =>
      openInBrowser(containerManager),
    ),
  );
