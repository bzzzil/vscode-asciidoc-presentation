...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.preview", () => showPreview(containerManager)),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.exportHtml", (...args: any[]) =>
      exportHtml(containerManager, args),
    ),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.exportInlinedHtml", () =>
      exportInlinedHtml(containerManager),
    ),
  );
  context.subscriptions.push(
    vscode.commands.registerCommand("asciiDocPresentation.openInBrowser", () => openInBrowser(containerManager)),
  );
