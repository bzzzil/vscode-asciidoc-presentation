...
// :revealjs_parallaxBackgroundImage: https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/PNG_transparency_demonstration_1.png/200px-PNG_transparency_demonstration_1.png
...
Many reveal.js parameters can be set as document attributes.
